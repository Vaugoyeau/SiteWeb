...
Après avoir vérifié qu'il n'y avait pas d'[erreur de typographie](https://mvaugoyeau.netlify.com/fr/post/comment-je-verifie-les-donnees/) dans les données et avant de commencer les vraies analyses statistiques, je vérifie toujours la distribution des données et les relations entre les facteurs.  
