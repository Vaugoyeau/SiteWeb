...
read_pptx("template_rstudio_article_off.pptx") %>%
  layout_properties()



support <- read_pptx("content/post/template_rstudio_article_off.pptx") %>% 
...
support %>% 
  print("presentation_test.pptx")


#### STOP 
Section : Présentation de Comerso
  add_slide(
    layout = "Titre de section",
    master = "Conception personnalisée"
  ) %>% 
  ph_with(
    value = "Présentation de Comerso",
    location = ph_location_label("Espace réservé du texte 8")
  ) %>% 
  
  # 3. Ajout de la diapo Process
  add_slide(
    layout = "Process comerso",
    master = "Conception personnalisée"
  ) %>% 
  
  # 4. Ajout de la diapo de qui est comerso
  add_slide(
    layout = "Qui est comerso",
    master = "Conception personnalisée"
  ) %>% 
  
  # 5. Section : Création du support
  add_slide(
    layout = "Titre de section",
    master = "Conception personnalisée"
  ) %>% 
  ...
  # 6. Ajout d'un graphique
  add_slide(
    layout = "Titre, image et legende",
    master = "Conception personnalisée"
  ) %>% 
  ph_with(
    value = "Ajout d'un graphique",
    location = ph_location_label("Titre 1")
  ) %>% 
  ph_with(
    value = graph(),
    location = ph_location_label("Espace réservé du contenu 2")
  ) %>% 
  ph_with(
    value = "Graphique réalisée",
    location = ph_location_label("Espace réservé du texte 4")
  ) %>% 
  
  # 7. Ajout d'une signature
  add_slide(
    layout = "Signature",
    master = "Conception personnalisée"
  )
