...
creation_du_support <- function(num_identifiant_pingouin){
  read_pptx(emplacement_du_support) %>% 
    ...
    ph_with(
      value = external_img("content/post/pingouin.png"),
...
num_identifiant_pingouin <- "-0.993421052631561 422"

message_support <- mime_part(
  creation_du_support(num_identifiant_pingouin), 
  "support.pptx"
  )

message_support$`Content-Type` <- "application/vnd.openxmlformats-officedocument.presentationml.presentation"

adresse_d_envoi <- "marie.vaugoyeau@gmail.com"
adresse_du_pingouin <- "marie.vaugoyeau@gmail.com"
...
sendmail(
  ...
  "test",
  "envoi test",
  control = list(host = "aspmx.l.google.com", port = 465, user.name = "marie.vaugoyeau@gmail.com", passwd = "06m07V12!")
)

from <- "<nousdeux0515@gmail.com>"
to <- "<marie.vaugoyeau@gmail.com>"
...
support <- "-0.993421052631561 422" %>% 
  creation_du_support()
  

support <- "-0.993421052631561 308" %>% 
  creation_du_support()
