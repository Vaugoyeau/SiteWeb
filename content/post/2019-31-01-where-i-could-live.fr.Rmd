...
Cette article est pour moi l'occasion de partager un truc que j'ai découvert sur R en utilisant le package `leaflet` : la possibilité de dessiner une zone de couleur autour d'un point GPS donné.  
