...
featuredalt: "Mon premier article"
linktitle: "mon-premier-article"
images: 
  - /img/featured/DesignCroise.png  
description : "Les analyses statistiques que j'ai réalisé pour mon premier article publié"
output:
  blogdown::html_page:
    toc: true
---
  
En 2015, j'ai publié [l'article](http://jeb.biologists.org/content/218/13/2106) : *Is oxidative status influenced by dietary carotenoid and physical activity after moult in the great tit (Parus major)?* sur ma première expérimentation.  
